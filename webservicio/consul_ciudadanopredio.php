...
if(isset($_POST["idemp"]))
  ...
  {
/////////////////////////////////////////////////////////CONSULTA PREDIAL
 $sql = "select CIU,CEDULA,CLAVE,NOMBRE,DIRECCION,AVALUO_REAL,TERRENO,TIENECONSTRUCCION from V_URBANORUSTICO where ".$opcampos[1]."='".$_POST["idemp"]."'";
