...
//////ojo hay q descomentar    extension=php_soap.dll   de php.ini
    ...
    $server->configureWSDL("consulciudadanodatxcedula", "urn:consulciudadanodatxcedula");
	
	$server->register('MetodoConsultaId',
   // array('miparam_id' => 'xsd:string','param_txt' => 'xsd:string'),
	array('miparam_id' => 'xsd:string'),
    array('return' => 'xsd:string'),
    'urn:consulciudadanodatxcedula',
    'urn:consulciudadanodatxcedula#MetodoConsultaId',
    'rpc',
    'encoded',
    'Retorna el datos'
	);
   ...
   // function MetodoConsulta($param_id,$param_txt) {
      function MetodoConsultaId($miparametro) {
		...
		$sql = "SELECT GEN01CODI,GEN01RUC,GEN01NOM,GEN01APE,GEN01COM,GEN01DIR,GEN01TELF,GEN01EMAIL,GEN01SEX,GEN01FNAC,GEN01DISCA FROM  GEN01 WHERE GEN01RUC='".$miparametro."'";
