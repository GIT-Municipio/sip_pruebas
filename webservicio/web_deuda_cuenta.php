...
<body>
<form name="form1" action="web_deuda_cuenta.php" method="post">

<table width="960" height="5" border="0" align="center" cellpadding="1" cellspacing="2">
<tr>
  <td><span class="tema_titulo"><img src="images/logo_secundario.png" alt="municipio" width="145" height="70" border="0" align="middle" />Sistema de Información</span> <span class="tema_presentacion">Ciudadano</span></td>
  <td align="right"><img src="images/banner_deduda.jpg" alt="deuda_prishard" width="250" height="70" border="0" /></td>
</tr>
<tr>
  <td colspan="2" align="left" valign="middle">&nbsp;</td>
  </tr>
<tr>
<td width="639" align="left" valign="middle"><a href="index.php"><img src="images/inicio_boton.png" alt="Inicio" width="32" height="32" border="0" align="absmiddle" /></a> <span class="texto">Regreso a la pantalla inicial</span></td>
<td width="311">&nbsp; </td>

</tr>
<tr>
  <td colspan="2" align="left" valign="middle" class="texto"> Atención oportuna y automatizada,  la información al dia de todas las obligaciones con la municipalidad. Revise su estado de cuenta, digite el criterio de consulta por CIU, Identificacion (Ruc, Cedula, Pasaporte), coloque en el casillero la informacion y luego ponga buscar</td>
  </tr>
<tr>
  <td>&nbsp;</td>
  <td>&nbsp;</td>
...
<tr>
<td width="249" align="right" valign="middle" class="texto"><label >Ingrese la información a realizar la busqueda:</label></td>
<td width="395" align="center" valign="middle"  class="detalle_grid">

<input name="datos" type="text" size="40" />
<label> Resultados</label><?php 
global $miconexion;
$num = array(100,10,5);
$numr = array('>10',10,5);
$miconexion->_combof('tipo',$num,$numr,3,'imput'); ?></td>
<td width="292"><input name="enviar" type="submit" id="enviar" /><input name="borrar" value="Limpiar" type="reset"  onClick="window.location.href=window.location.href"/>
