	...
	<script>
		...
		function doOnLoad() {
			...
			myLayout = new dhtmlXLayoutObject({
				...
				//parent: "layoutObj",
				pattern: "3J",
				cells: [{id: "a", text: "Cargar Documento(s) Escaneados >>> ", width: 410, height: 250   },{id: "b", text: "Visualizar Informacion"   },{id: "c", text: "Visualizar Anexo"   } ]
...
formData = [
  {type: "settings", position: "label-left", labelWidth: 100, inputWidth: 120},
	{type: "fieldset", label: "Anexos: ",  offsetLeft: 5, offsetRight: 5, offsetTop: 0, inputWidth: 360, list:[		
		...
		{type: "upload", name: "myFiles", inputWidth: 310,   offsetTop: 0, url: "php/carga_upload_imgs_docs.php", autoStart: true, swfPath: "uploader.swf", swfUrl: "php/carga_upload_imgs_docs.php"},
]},
...
{type: "button", value: ">>>  ACEPTAR <<<", name: "send", offsetLeft: 10,offsetTop: 20,  width: 160,   className: "button_save"}			
			...
			myForm.attachEvent("onUploadComplete",function(count){
				...
				//alert("todo bien");
			    myGrid.load("php/oper_mostrar_elemrespues.php?mitabla=<?php echo "tbli_esq_plant_formunico_respuestanexo"; ?>&enviocampos=<?php echo "id,nombre_anexo,url_anexo,validado,img_respuesta_eliminar"; ?>&envioclientid=<?php echo $_GET["mvpr"]; ?>");
			});
...
//============================================================================================
			myDataProcessor = new dataProcessor("php/oper_update_allgrid.php?mitabla=<?php echo "tbli_esq_plant_formunico_respuestanexo"; ?>&enviocampos=<?php echo "id,nombre_anexo,url_anexo,validado"; ?>"); //lock feed url
				  ...
				  if(cellIndex==4)
					{  
		     		dhtmlx.confirm({
								...
								if ( result )
						   			{
			                   			document.location.href="opt_acciones/crea_eliminar_anexo_tecnic.php?vafil="+datovalorid;
						  			 }
						   		else
