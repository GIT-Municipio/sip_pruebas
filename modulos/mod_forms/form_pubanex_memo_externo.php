...
if ($inicial) {
	...
	$sqlus = "SELECT usua_cedula, usua_nomb, usua_email, usua_apellido, usua_email, usua_abr_titulo, usua_cargo, usu_departamento 
	...
	if ($usuarioseleccionado != null) {
		...
		'" . $txtnombres . "',' ',' ',' ', 'FORMULARIO EXTERNO', 
		'" . $asunto . "','1','" . $tipodocumento . "','EXTERNO','" . $usuarioseleccionado . "', 1,'-',
...
if ($usua_email != null) {
	try {
		...
		//Recipients
		$mail->setFrom('municotacachi@gmail.com', 'Gestion Documental');
		$mail->addAddress($usua_email, $txtnombres);     // Add a recipient
		...
		$mail->Subject = $asunto;
		$mail->Body    = utf8_decode("Ha recibido un nuevo documento en el Sistema de Gesti&oacute;n Documental - Municipio de Cotacachi, <br>
		<br>Nro. Trámite: ".$numerotramite."
		<br>Nro. Documento: ".$varcoditramite."
		<br>Asunto: ".$asunto."
		<br>Origen: " .$nombres." - ".$departamento_usuario."  
