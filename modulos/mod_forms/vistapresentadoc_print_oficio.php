...
$sqlconstab = "SELECT plan.id,plan.nombre_tablabdd,contin.nom_responsable,contin.ref_nom_depart,contin.detalle from tbli_esq_plant_form_plantilla plan,tbli_esq_plant_form_cuadro_clasif contin where plan.ref_clasif_doc=contin.id and plan.id='998' order by id";
...
$sql = "SELECT id, fecha, fecha_atencion, cod_tramite_tempo, cod_traminterno,codi_barras, codigo_tramite, ciu_cedula, campo_1, campo_2, campo_3, campo_4, campo_5, campo_6, campo_9, campo_11  FROM " . $darmetablaext . " where id='" . $_GET["varclaveuntramusu"] . "'  ;";
...
$nombrepara = pg_fetch_result($resxpresdocum, 0, 'campo_4');
    ...
    <table width="90%" border="0">
      <tr>
        ...
        <td style="font-size: 14px; LINE-HEIGHT:1px;">        
            <p style="font-size: 14px; LINE-HEIGHT:1px;"><?php echo $nombrepara; ?>
