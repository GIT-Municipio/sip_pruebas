...
echo "<script>
     document.location.href='app_tipo_textopredefinido.php?vcodigplantillavar=".$_GET["varidplantilla"]."&vnombretabplantilla=".$vernombretabla."&vnombrecampo=".$vernombrecampoupdate."&vidcampousado=".$_GET["varidenvcmp"]."&varclaveuntramusu=0';
      </script>";
