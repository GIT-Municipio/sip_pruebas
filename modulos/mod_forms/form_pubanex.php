	...
	<script>
		...
		function doOnLoad() {
			...
			myLayout = new dhtmlXLayoutObject({
				...
				//parent: "layoutObj",
				pattern: "3J",
				cells: [{id: "a", text: "Cargar Documento(s) Escaneados >>> ", width: 480, height: 180   },{id: "b", text: "Visualizar Informacion"   },{id: "c", text: "Visualizar Anexo Plantilla: <?php echo $_GET["mvpr"];?>"   } ]
...
formData = [
  {type: "settings", position: "label-left", labelWidth: 100, inputWidth: 120},
	...
	{type:"newcolumn"},
{type: "button", value: "ACEPTAR >>", name: "send", offsetLeft: 10,offsetTop: 10,  width: 150,   className: "button_save"},			
{type: "button", value: "<< REGRESAR ", name: "cancel", offsetLeft: 10,offsetTop: 10,  width: 150,   className: "button_cancel"}			
			...
			myForm.attachEvent("onButtonClick", function(id){
				...
				if (id == "cancel") 
				{
					document.location.href="form_pubusu.php?rp=<?php echo $_GET["mvpr"];?>&varclaveuntramusu=<?php echo $_GET["varclaveuntramusu"]; ?>";
				}
				...
				if (id == "send") 
					{
						  ...
						  //  type:"confirm",
						    ...
						    callback: function() {
								...
								document.location.href="vistapresentadoc_print.php?varidplanty=<?php echo $_GET["mvpr"]; ?>&varclaveuntramusu=<?php echo $_GET["varclaveuntramusu"];?>";
								//window.close();
