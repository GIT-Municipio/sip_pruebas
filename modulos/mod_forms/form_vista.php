...
*/
  ...
  <script type="text/javascript">
	...
	function crearformularionuevo(vafcodnuevocre)
	{
	    ////////////////////////////////////////////////
			 dhtmlx.confirm({
								title:"Mensaje!",
								//type:"confirm-warning",
								text:"Se va crear un NUEVO TRAMITE \n Desea continuar?",
								callback:function(result){
								if ( result )
						   			{
										document.location.href="form_pub.php?varidplanty="+vafcodnuevocre;
						  			 }
						   		else
									{
						      			dhtmlx.alert({
...
<body>
<br/>
<div id="tit" style="background-color:#FFC; width:100%; ">
<br/>
<b>
<marquee behavior="alternate">
<font color="#0000FF">PARA GENERAR SU TRAMITE DEBE HACER CLICK EN</font><font color="#FF0000"> "LLENAR FORMULARIO"</font>
</marquee>
<br/>
</b>
<br/>
...
<table width="100%" border="0" bgcolor="#FFFFFF">
  <tr>
    ...
    <td width="164" align="center"><table width="200" border="0">
        <tr>
          <td align="center"><a href="#" onclick="crearformularionuevo(<?php echo $_GET['rp']; ?>);"><img src="imgs/categories.png" width="48" height="48" border="0" /></a></td>
        </tr>
        <tr>
