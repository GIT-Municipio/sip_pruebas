    ...
    <head>
	   ...
	   <script src="codebase/dhtmlx.js"></script>
        ...
        <script type="text/javascript">
            ...
            var australia = new google.maps.LatLng(0.349854, -78.118396);
...
//////////////////////////////////////////////////
	...
	{         
		...
		//  document.getElementById("mostrarcoordsreal").innerHTML=marker.getPosition().lat() +"," + marker.getPosition().lng();;
...
<script type="text/javascript">
			...
			sbObj = myLayout.attachStatusBar({text:"<form id='formcoords' name='formcoords' method='post' action='actual_coordenadas.php'><input name='ponref_plantilla' type='hidden' id='ponref_plantilla' value='<?php echo $_GET['ponref_plantilla']; ?>'  /><input name='varitabcmpid' type='hidden' id='varitabcmpid' value='<?php echo $_GET['varitabcmpid']; ?>'  /><input name='varclaveuntramusu' type='hidden' id='varclaveuntramusu' value='<?php echo $_GET['varclaveuntramusu']; ?>'  /><input name='<?php echo $_GET['varitabcmpid']; ?>' type='hidden' id='<?php echo $_GET['varitabcmpid']; ?>' value=''  /><input type='submit' name='btnenviar' id='btnenviar' value='FIJAR COORDENADAS' style='color:#000;width:202px;height:40px; font-size:14px' /><div id='mostrarcoordsreal'></div></form>"});
