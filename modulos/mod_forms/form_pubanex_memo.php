...
if ($inicial) {
	...
	campo_0, campo_1, campo_2, campo_3, campo_4, campo_5, campo_6, campo_7, campo_9, ciu_cedula, estadodoc, cod_traminterno) VALUES ( ";
	...
	'$departamentoRemitente', '$asunto', '$texto', '$descripcion', '$tipodocumento','$fecha', '$vistobueno',
	...
	if ($correosCopia != null) {
		...
		'','','', 'MEMORANDO', '" . $asunto . "','1', '" . $tipodocumento . "','COPIA',
	...
	foreach ($correosPara as $row) {
		...
		(default,'" . $cedulaRemitente . "','','" . $codigoDocumento . "','" . $cedulaRemitente . "',
		...
		'" . $varcoditramite . "','999', '999','ENVIADO','ENVIADO', 1,'" . $numerotramite . "')";
		$rescodpers = pg_query($conn, $insertdato);
