...
$vertamancpm=pg_num_rows($consulcamps);
 ...
 $query = "UPDATE plantillas.".$darmetabla." SET estadodoc='PENDIENTE',";
...
echo "<script>document.location.href='form_pubanex.php?mvpr=".$darmeid."&varclaveuntramusu=".$_POST["mivarplancodtramite"]."&pontblanexo=".$darmtablanexos."'</script>";
