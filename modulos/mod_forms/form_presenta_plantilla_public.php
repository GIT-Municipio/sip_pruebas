...
<table width="100%" border="0" bgcolor="#FFFFFF">
  ...
  <tr>
    ...
    for($grup=0;$grup<pg_num_rows($resulvgrups);$grup++)
	{
		...
		$sqlcamps = "select id,campo_creado,campo_nombre,campo_requerido,ref_tcamp,campo_orden,nombre_tablacmp,ref_plantilla,nombre_combocmp,publico  FROM tbli_esq_plant_form_plantilla_campos where ref_plantilla='".$_GET['varidplanty']."' and ref_grupo='".pg_fetch_result($resulvgrups,$grup,"id")."' and campo_activo=1 order by campo_orden; ";
		...
		echo '<table width="100%" border="1" cellpadding="0" cellspacing="0">';
		 for($items=0;$items<pg_num_rows($resulvcamps);$items++)
	     {
			...
			//////////////////////FILA///////////
			 echo '<tr>';
			 if(pg_fetch_result($resulvcamps,$items,"ref_tcamp")==10)
			{
