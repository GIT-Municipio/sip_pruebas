...
/////////////////CONSULTO LA TABLA
 $sqlconstab = "SELECT id,nombre_tablabdd,nombre_plantilla,ref_clasif_doc from tbli_esq_plant_form_plantilla where id='".$_GET['varidplanty']."' order by id";
$resconstab = pg_query($conn, $sqlconstab);
$darmetablaext= "plantillas.".pg_fetch_result($resconstab,0,'nombre_tablabdd');
$varorignomtram = pg_fetch_result($resconstab,0,'nombre_plantilla');
$varcodicuadclasif = pg_fetch_result($resconstab,0,'ref_clasif_doc');


/////////VISTA
$param_tablavista=$darmetablaext;
...
/////////EDICION
$param_tablaedit=$darmetablaext;
$param_camprimarioedit="id";
////////////////////////////////////////


/////////////////TODOS LOS CAMPOS
$campostodos="id, fecha, fecha_atencion, cod_tramite_tempo,  campo_1 as cedula,campo_2 as nombre,campo_3 as apellido,cod_traminterno, codi_barras, codigo_tramite,estadodoc";
...
////////////////CAMPOS TAMAÑO////////////
$camposparatamanios= array("id"=>"30", "fecha"=>"80", "fecha_atencion"=>"70", "cod_tramite_tempo"=>"150", "cod_traminterno"=>"120", "codi_barras"=>"100", "codigo_tramite"=>"100", "ciu_cedula"=>"80", "cedula"=>"100", "campo_1"=>"100", "campo_2"=>"70", "estadodoc"=>"80");
/////////////////////////////////////////////////////////////////////////////
...
<head>
    ...
    <style type="text/css">
		...
		.vistamostrarseguim {
    		background-image: url(imgs/btnforms_solic.png) !important;
		...
		.vistaanexosicon {
    		background-image: url(imgs/btnforms_valid.png) !important;
    		width:50px!important;
    		height:30px!important;
    		margin-right: auto !important;
    		margin-left: auto !important;
...
/////////////////////////ACCIONES DE GRID////////////////////////////////////
			  {
					...
					{xtype: 'space'},
					{
                        ...
                        tooltip:'Mostrar Solicitud Impresa',	
                        ...
                        handler:function(grid, rowIndex, colIndex) {
							  ...
							  */
							  ...
							  miPopupmapaobjtabauxgrf = window.open("../mod_forms/vistapresentadoc_print.php?varidplanty=<?php echo $_GET['varidplanty']; ?>&varclaveuntramusu="+ponidver,"moswinform","width=900,height=600,scrollbars=no,left=400");
					...
					//{xtype: 'space'},
					{
                        ...
                        handler:function(grid, rowIndex, colIndex) {
							  ...
							  */
							  ...
							  //var ponidver= employee.get('codi_barras');
							  var miPopupmapaobjtabauxgrf;
							  miPopupmapaobjtabauxgrf = window.open("../mod_forms/vista_previatramusu.php?varidplanty=<?php echo $_GET['varidplanty']; ?>&varclaveuntramusu="+ponidver,"moswinform","width=900,height=600,scrollbars=no,left=400");
							  miPopupmapaobjtabauxgrf.focus();
                        ...
                        handler:function(grid, rowIndex, colIndex) {
							  ...
							  */
							  ...
							  dhtmlx.confirm({
								...
								text:"El documento se validara como tramite HABILITADO \n En realidad desea Validar este documento?",
								callback:function(result){
								if ( result )
						   			{
										document.location.href='guardarventanilla.php?varidplanty=<?php echo $_GET['varidplanty']; ?>&varclaveuntramusu='+ponidver;
						  			 }
						   		else
									{
						      			dhtmlx.alert({
...
//	var grid = Ext.create('Ext.ux.LiveSearchGridPanel', {    ////PANEL CON BUSQUEDAS
		...
		*/
		...
		fbar  : [
		'Solicitudes emitidas: <?php echo $varorignomtram; ?>',
