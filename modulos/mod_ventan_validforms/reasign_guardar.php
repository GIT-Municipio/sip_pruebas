...
////actualizo el tramite
 $sqlaactfre ="UPDATE public.tbli_esq_plant_formunico SET  estado_gestor='imgs/btninfo_estado_reasignado.png', observacion='".$mensobsre."',estadodoc='ASIGNADO',asignado=1 WHERE form_cod_barras='".$_GET["varcodgenerado"]."';";
$resfre = pg_query($conn, $sqlaactfre);
}
