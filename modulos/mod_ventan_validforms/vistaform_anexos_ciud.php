...
//echo $_SESSION["tempoanex_codtramite"]=$_GET["vercodigotramitext"];
//echo $_SESSION["tempoanex_ciudcedula"]=$_GET["vartxtciudcedula"];
...
formData = [
  {type: "settings", position: "label-left", labelWidth: 100, inputWidth: 120},
	{type: "fieldset", label: "Anexos: ",  offsetLeft: 5, offsetRight: 5, offsetTop: 0, inputWidth: 360, list:[		
		...
		<?php if($_SESSION["sesusuario_usu_ventanilla"]==1) { ?>
		{type: "upload", name: "myFiles", inputWidth: 310,   offsetTop: 0, url: "php/carga_upload_imgs_ventan.php?vartxtciudcedula=<?php echo $_GET["vartxtciudcedula"];?>&vercodigotramitext=<?php echo $_GET["vercodigotramitext"];?>&ponnombresrespon=<?php echo $ponnombresrespon;?>", autoStart: true, swfPath: "uploader.swf", swfUrl: "php/carga_upload_imgs_ventan.php"},
		
		<?php } else { ?>
		
		{type: "upload", name: "myFiles", inputWidth: 310,   offsetTop: 0, url: "php/carga_upload_imgs_asist.php?vartxtciudcedula=<?php echo $_GET["vartxtciudcedula"];?>&vercodigotramitext=<?php echo $_GET["vercodigotramitext"];?>&ponnombresrespon=<?php echo $ponnombresrespon;?>", autoStart: true, swfPath: "uploader.swf", swfUrl: "php/carga_upload_imgs_asist.php"},
		<?php } ?>
...
{type: "button", value: ">>>  ACEPTAR <<<", name: "send", offsetLeft: 10,offsetTop: 20,  width: 160,   className: "button_save"}			
			...
			myForm.attachEvent("onUploadComplete",function(count){
				//alert("todo bien");
			    myGrid.loadXML("php/oper_mostrar_elem_ciu.php?mitabla=<?php echo "tbli_esq_plant_formunico_anexo"; ?>&enviocampos=<?php echo "id,nombre_anexo,url_anexo,validado,img_respuesta_eliminar"; ?>&envioclientid=<?php echo $_GET["varcodgenerado"]; ?>");
			});
				...
				if (id == "send") 
					{
						  ...
						  //  type:"confirm",
						    ...
						    callback: function() {
								...
								//document.location.href="vistaform_anexos_ciud.php?mvpr=<?php echo $_GET["mvpr"]; ?>&varcodgenerado=<?php echo $_GET["varcodgenerado"]; ?>&verrmisfechas=<?php echo $_GET["verrmisfechas"]; ?>";
								parent.window.close();
