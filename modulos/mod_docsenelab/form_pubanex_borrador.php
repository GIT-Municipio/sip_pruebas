...
if ($inicial) {
	...
	$apellidosRemitente = $nombre_temp.' '.$apellido_temp;
	// $ponnombresrespon = $_SESSION['sesusuario_nomcompletos'];
	$cargoRemitente = $cargo_temp;
	$departamentoRemitente = $departamento_temp;
	...
	$descripcion = $_COOKIE['txtdescripcion'];
	...
	$insertdato = "INSERT INTO tbli_esq_plant_formunico_docsinternos(id,usu_respons_edit,
		respuesta_anexotxt,	codigo_documento, origen_cedul,origen_nombres,origen_ciud_domicilio,
