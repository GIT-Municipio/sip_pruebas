...
function ver_de_para(){
	document.getElementById("buscar_inst").selectedIndex=1;
	buscar_resultado('boton');
...
///////////////selecciono valor por defecto
//document.getElementById("buscar_inst").selectedIndex=3;
//buscar_depePadre();
///////////////////////////////////////////
</script>
...
<table border=0 width="100%" class="borde_tab" cellpadding="0" cellspacing="5">
  <tr>
    <td width="11%" class="listado5" align="center" background="../img/mdegrad6.png">

      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td width="20%"><font class="tituloListado"><img src="../img/user.png" width="40" height="40"></font></td>
          <td width="80%"><font class="tituloListado" color="#FFFFFF">BUSCAR PERSONA: </font></td>
        </tr>
      </table></td>
    <td width="78%" class="listado5" valign="middle" bgcolor="#e3e8ec">
    <table width="100%">
        <?php
        ...
        <tr>
          <td colspan="2" align="center"><table width="100%" border="0">
            ...
            ?>
              ...
              <td width="13%" align="right"><span class="listado5">Tipo de Usuario: </span></td>
            <td width="22%">
              ...
              <td width="26%" align="right"><span class="listado5"><label id="lbl_datos_usua">Datos Usuario:</label> </span> </td>
            <td width="39%" >
<!--                <input type=text id="buscar_nom" name="buscar_nom" value="<?=$buscar_nom?>" class="tex_area"/>                -->
                ...
                &nbsp;&nbsp;(c&eacute;dula, nombre, cargo, email, instituci&oacute;n, &aacute;rea)
            </td>
...
<? } ?>
    ...
    <td width="11%" align="center" class="listado5" background="../img/mdegrad6.png" >
...
<?php if ($_SESSION["inst_codi"] > 1) { // Si es ciudadano el que crea el documento ?>
  <tr>
    <td height="32" background="../img/menu_trambtn1.png" class="listado5"><table width="177" border="0" cellpadding="0" cellspacing="0">
      <tr>
          <td width="33"><font class="tituloListado"><img src="../img/toggle_log.png" width="32" height="32"></font></td>
          <td width="144" ><font class="tituloListado" color="#FFFFFF">LISTAS DE ENV&Iacute;O: </font></td>
        </tr>
    </table></td>
    <td colspan="2" valign="middle" class="listado5">
      <table width="95%">
        <tr>
          <td width="16%" align="right"><span class="listado5">Nombre de la lista:</span></td><td width="7%">
            <?php
          ...
          <td width="19%" align="right"><span class="listado5">Listas Seleccionadas:</span></td>
          <td width="58%">
            <input name="radi_lista_nombre" id="radi_lista_nombre" class="select" value="<?=$radi_lista_nombre?>" size="32" readonly>
            &nbsp;&nbsp;
            <a class="vinculos" href="#" onClick="borrar_lista();" title="Borrará el nombre de la lista seleccionada">Borrar nombre lista</a>
            &nbsp;|&nbsp;
...
<table class=borde_tab width="100%" cellpadding="0" cellspacing="4">
    <tr class=listado2>	<td colspan="10" background="../img/btnestilo.jpg">
...
<table class=borde_tab width="100%" cellpadding="0" cellspacing="4">
    <tr class="listado2">
        <td colspan="10" background="../img/btnestilo.jpg">
...
<div style="background-image:url(../img/piepag.png)">
