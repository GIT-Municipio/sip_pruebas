...
if($parent_id !="")
  {
	  ...
	  {
  $query = "SELECT id, origen_tipodoc||' Usuario: '||origen_nombres||' Asunto: '||origen_form_asunto as text, ultimonivel as leaf, origen_fecha_creado as fecha,hora_ingreso, respuesta_estado as estado, destino_nombres,destino_cargo  FROM public.tbli_esq_plant_formunico_docsinternos WHERE codi_barras='".$_GET['enviocodbarr']."' and parent_id='".$parent_id."' order by item_orden ";
	  }
	  else
	  {
