					...
					dhtmlx.confirm({
						...
						callback: function(result) {
							if (result) {
								...
								// miPopupmapaobjtabauxgrf = window.open("crea_eliminar_anexo_ciud.php?vafil=" + datovalorid, "width=950,height=650,scrollbars=no,left=400");
								...
								// w1.attachURL("crea_eliminar_anexo_ciud.php?vafil=" + datovalorid);
								// // w1.setModal(true);
								
								// w1.close();
								// w1.opener.location.reload(true);
								
								// var miPopupmapaobjtabauxgrf;
 								// miPopupmapaobjtabauxgrf = window.open("crea_eliminar_anexo_ciud.php?vafil=" + datovalorid, "moswinform", "width=900,height=500,scrollbars=no,left=400");
