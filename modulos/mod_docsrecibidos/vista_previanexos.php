...
function doOnLoad() {
	...
	cells: [{id: "a", text: "Elementos Enviados..."  }  ]
		...
		myTabbar = myLayout.cells("a").attachTabbar({
				//parent: "accObj",
				tabs: [
					{id: "a1", text: "<div class='tab_docsitemsciu'>-- ANEXOS DEL CIUDADANO --</div>" },
					{id: "a2", text: "<div class='tab_docsitems'>-- ANEXOS DE RESPUESTA --</div>", active: true},
				]
			});
	
	
	myTabbar.tabs("a1").attachURL("vistaform_anexos_ciud.php?mvpr=<?php echo $_GET["mvpr"]; ?>&varcodgenerado=<?php echo $_GET["varcodgenerado"]; ?>");
