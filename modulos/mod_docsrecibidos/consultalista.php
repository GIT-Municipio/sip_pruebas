      ...
      if(isset($_GET['mibtnopcionbandeja'])!="")
       {
		   ...
		   switch($_GET['mibtnopcionbandeja'])
            {
	            case "1":  $query = "SELECT ".$_GET['milistcampos']." FROM ".$_GET['mitablavista']." WHERE est_respuesta_recibido=1 and est_respuesta_reasignado=0 and est_respuesta_archivado=0 and  destino_cedul='".$_GET['micmpususeguim']."' and ".$where;
		                   break;
				 case "2":  $query = "SELECT ".$_GET['milistcampos']." FROM ".$_GET['mitablavista']." WHERE est_respuesta_enviado=1 and est_respueta_archivado=1 and origen_cedul='".$_GET['micmpususeguim']."' and ".$where;
		                   break;
				 case "3":  $query = "SELECT ".$_GET['milistcampos']." FROM ".$_GET['mitablavista']." WHERE est_respuesta_reasignado=1 and origen_cedul='".$_GET['micmpususeguim']."' and ".$where;
		                   break;
				 ...
				 case "6":  $query = "SELECT ".$_GET['milistcampos']." FROM ".$_GET['mitablavista']." WHERE est_respuesta_informado=1 and destino_cedul='".$_GET['micmpususeguim']."' and ".$where;
		                   break;
			     case "7":  $query = "SELECT ".$_GET['milistcampos']." FROM ".$_GET['mitablavista']." WHERE est_respuesta_archivado=1 and destino_cedul='".$_GET['micmpususeguim']."' and ".$where;
		                   break;			   
			     case "8":  $query = "SELECT ".$_GET['milistcampos']." FROM ".$_GET['mitablavista']." WHERE est_respuesta_eliminado=1 and origen_cedul='".$_GET['micmpususeguim']."' and ".$where;
		                   break;	
                 case "9":  $query = "SELECT ".$_GET['milistcampos']." FROM ".$_GET['mitablavista']." WHERE est_respuesta_recibido=1 and est_respuesta_reasignado=0 and est_respuesta_archivado=1 and  destino_cedul='".$_GET['micmpususeguim']."' and ".$where;
                          break;
		   ...
		   switch($_GET['mibtnopcionbandeja'])
            {
				...
				case "6":  $total = pg_query($conn,"SELECT COUNT(*) FROM ".$_GET['mitablavista']." WHERE est_respuesta_informado=1 and  destino_cedul='".$_GET['micmpususeguim']."' and ".$where);
		                   break;
			    case "7":  $total = pg_query($conn,"SELECT COUNT(*) FROM ".$_GET['mitablavista']." WHERE est_respuesta_archivado=1 and  destino_cedul='".$_GET['micmpususeguim']."' and ".$where);
		                   break;
				case "8":  $total = pg_query($conn,"SELECT COUNT(*) FROM ".$_GET['mitablavista']." WHERE est_respuesta_eliminado=1 and  destino_cedul='".$_GET['micmpususeguim']."' and ".$where);
		                   break;		   
