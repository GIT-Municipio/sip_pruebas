...
if($_GET[envioidepart]!="")
$sql = "SELECT  ".$_GET[enviocampos]." from ".$_GET[mitabla]." where cod_depenid='".$_GET[envioidepart]."' and usu_activo=1 order by id";
else
$sql = "SELECT  ".$_GET[enviocampos]." from ".$_GET[mitabla]." where usu_activo=1 order by id";
