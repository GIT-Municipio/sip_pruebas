...
$sql = "SELECT  ".$_GET[enviocampos]." from ".$_GET[mitabla]." where est_respuesta_recibido = 1 and (destino_cedul='".$_GET[enviusurespons]."'   or usu_respons_edit='".$_GET[enviusurespons]."' ) ";
else
