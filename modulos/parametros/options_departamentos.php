<?php
   // $latabla='carto_fa_ecuador_parroquial';
	...
	$sql = "SELECT id, nombre_departamento   FROM tblb_org_departamento order by id;";
...
if ($_REQUEST["t"] == "combo") {
	...
	echo '<?xml version="1.0" encoding="utf-8"?>'.'<complete>';
      for($im=0;$im<$numerdatos;$im++)
	  {
	    echo "<option value='".pg_fetch_result($resulprovs,$im,1)."'>".pg_fetch_result($resulprovs,$im,1)."</option>";
	  }
	echo	"</complete>";
	/////////////////////////////////////////////
