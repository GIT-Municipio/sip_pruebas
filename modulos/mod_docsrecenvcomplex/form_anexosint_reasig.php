...
$sqlintecn = "SELECT * FROM public.tbli_esq_plant_formunico_docsinternos where codi_barras='".$_GET["varcodgenerado"]."' and  origen_cargo='CIUDADANO' ;";
...
formData = [
  {type: "settings", position: "label-left", labelWidth: 100, inputWidth: 120},
	{type: "fieldset", label: "Anexos: ",  offsetLeft: 5, offsetRight: 5, offsetTop: 0, inputWidth: 360, list:[		
		...
		{type: "upload", name: "myFiles", inputWidth: 310,   offsetTop: 0, url: "php/carga_upload_imgs_instit.php?vartxtciudcedula=<?php echo $darenvciucedul;?>&vercodigotramitext=<?php echo $darenvciucodtramt;?>", autoStart: true, swfPath: "uploader.swf", swfUrl: "php/carga_upload_imgs_instit.php"},
]},
