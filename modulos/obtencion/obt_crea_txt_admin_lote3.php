...
$sqlus="select ref_imagen,url_anexo_txt,cadena_exec from tbl_archivos_scanimgs_txt where estadoload=0 and id between  6000 and 9000";
...
$sqlusinterno="update tbl_archivos_scanimgs_txt set estadoload=1 where id between  6000 and 9000;";
$resultatxtint=pg_query($conn, $sqlusinterno);
