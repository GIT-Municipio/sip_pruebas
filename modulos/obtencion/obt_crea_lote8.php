...
$sqlus="select ref_imagen,url_anexo_txt,cadena_exec from tbl_archivos_scanimgs_txt where estadoload=0 and id between  19491 and 21022";
...
$sqlusinterno="update tbl_archivos_scanimgs_txt set estadoload=1 where id between  19491 and 21022;";
$resultatxtint=pg_query($conn, $sqlusinterno);
