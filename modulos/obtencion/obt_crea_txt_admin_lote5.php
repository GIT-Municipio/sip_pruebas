...
$sqlus="select ref_imagen,url_anexo_txt,cadena_exec from tbl_archivos_scanimgs_txt where estadoload=0 and id between  12000 and 16000";
...
$sqlusinterno="update tbl_archivos_scanimgs_txt set estadoload=1 where id between  12000 and 16000;";
$resultatxtint=pg_query($conn, $sqlusinterno);
