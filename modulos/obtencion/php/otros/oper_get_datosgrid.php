...
$sql = "SELECT  ".$_GET[enviocampos]." from ".$_GET[mitabla]." where usu_respons_edit='".$_GET[enviusurespons]."' and fecha='".$_SESSION["fechactualsipgad"]."' order by id";
else
$sql = "SELECT  ".$_GET[enviocampos]." from ".$_GET[mitabla]." where fecha='".$_SESSION["fechactualsipgad"]."' order by id";
