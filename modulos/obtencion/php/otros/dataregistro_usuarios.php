...
echo $parainresar="INSERT INTO data_modusuarios(
    ...
    VALUES ('".$_REQUEST[cedula]."', '".$_REQUEST[nombres]."', '".$_REQUEST[apellidos]."', '".$_REQUEST[cargo]."', '".$_REQUEST[titulo]."', '".$_REQUEST[email]."', '".$_REQUEST[telefono]."', '".$_REQUEST[usuario]."', '".$_REQUEST[clave]."', '".$_REQUEST[biografia]."', '".$_REQUEST[tipo_usuario]."', '".$_REQUEST[ref_departamento]."', '".$_REQUEST[data_tipo_activusuarios]."', '".$inicialescalc."');";
