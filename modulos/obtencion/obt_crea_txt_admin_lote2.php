...
$sqlus="select ref_imagen,url_anexo_txt,cadena_exec from tbl_archivos_scanimgs_txt where estadoload=0 and id between  3000 and 6000";
...
$sqlusinterno="update tbl_archivos_scanimgs_txt set estadoload=1 where id between  3000 and 6000;";
$resultatxtint=pg_query($conn, $sqlusinterno);
