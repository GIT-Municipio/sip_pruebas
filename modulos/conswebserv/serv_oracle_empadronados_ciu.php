  ...
  <tr>
    <td bgcolor="#CCCCCC"><table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td width="25" align="right"><a href="#" onclick="javascript:cerrarConsultatab()"><img src="../../imgs/close.png" width="14" height="14" /></a></td>
        </tr>
    </table></td>
  </tr>
  <tr>
...
if(isset($_POST["idemp"]))
  ...
  {
/////////////////////////////////////////////////////////CONSULTA PREDIAL
 $sql = "SELECT gen01codi,gen01ruc,gen01nom,gen01ape,gen01com,gen01dir,gen01telf,gen01email,gen01fnac,gen01disca  FROM gen01  WHERE gen01cont = 'O' and upper(".$opcampos[1].") like upper('%".$_POST["idemp"]."%')  and rownum <= 5 ";
			...
			for($km=2;$km<$totalmiscampos;$km++)
		       {
				//	if($opcampos[$km]!="DETALLE_TERRENO")
	               echo "<td  id='subtabfilainfo'>".utf8_encode($results[$opcampos[$km]][$i])."</td>";
			   }
			 echo "</tr>";  
		}
echo " </table>";
