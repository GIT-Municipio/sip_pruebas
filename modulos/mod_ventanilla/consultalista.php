		   ...
		   switch($_GET['mibtnopcionbandeja'])
            {
	            case "1":  $query = "SELECT ".$_GET['milistcampos']." FROM ".$_GET['mitablavista']." WHERE est_respuesta_recibido=1 and destino_cedul='".$_GET['micmpususeguim']."' and ".$where;
		                   break;
				 case "2":  $query = "SELECT ".$_GET['milistcampos']." FROM ".$_GET['mitablavista']." WHERE est_respuesta_enviado=1 and destino_cedul='".$_GET['micmpususeguim']."' and ".$where;
		                   break;
				 case "3":  $query = "SELECT ".$_GET['milistcampos']." FROM ".$_GET['mitablavista']." WHERE est_respuesta_reasignado=1 and destino_cedul='".$_GET['micmpususeguim']."' and ".$where;
		                   break;
				 case "4":  $query = "SELECT ".$_GET['milistcampos']." FROM ".$_GET['mitablavista']." WHERE est_respuesta_enedicion=1 and destino_cedul='".$_GET['micmpususeguim']."' and ".$where;
		                   break;
				 case "5":  $query = "SELECT ".$_GET['milistcampos']." FROM ".$_GET['mitablavista']." WHERE est_respuesta_enedicion=1 and destino_cedul='".$_GET['micmpususeguim']."' and ".$where;
		                   break;
			     ...
			     case "7":  $query = "SELECT ".$_GET['milistcampos']." FROM ".$_GET['mitablavista']." WHERE est_respuesta_archivado=1 and destino_cedul='".$_GET['micmpususeguim']."' and ".$where;
		                   break;			   
			     case "8":  $query = "SELECT ".$_GET['milistcampos']." FROM ".$_GET['mitablavista']." WHERE est_respuesta_eliminado=1 and destino_cedul='".$_GET['micmpususeguim']."' and ".$where;
		                   break;	
...
$query = "SELECT ".$_GET['milistcampos']." FROM ".$_GET['mitablavista']." WHERE origen_id_tipo_tramite='".$_GET['myidcuadclasif']."' and  ".$where;
	}
	else
...
$query .= " ORDER BY fecha desc,form_cod_barras desc ";
