...
$sqlanex = "INSERT INTO tbli_esq_plant_formunico_anexo(ref_formunic, nombre_anexo, url_anexo,validado,origen_codbarrasexp, usu_respons_edit, codigo_tramite, ref_docsinternos, anex_estado, anex_ventanilla, anex_asistencia,origen_codcedula,anex_responsable)  VALUES ('".$_SESSION["tempoanex_mvpr"]."', '".$nombredecapa."', '".$filename."',1,'".$_SESSION["tempoanex_codbarras"]."','".$_SESSION["sesusuario_cedula"]."','".$_GET["vercodigotramitext"]."',0,'INGRESO_VENTANILLA','".$_SESSION["tempoanex_verventan"]."','".$_SESSION["tempoanex_verasist"]."','".$_GET["vartxtciudcedula"]."','".$_GET["ponnombresrespon"]."');";
