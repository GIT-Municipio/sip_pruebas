...
if($_GET[mitabla]!="")
{
	if($_GET[mivarbusqsel]!="")
	{
	$sql = "SELECT  ".$_GET[enviocampos]." from ".$_GET[mitabla]." where activo=1 and cod_clase='".$_GET[mivarbusqsel]."' order by id";
	}
	else
	{
	$sql = "SELECT  ".$_GET[enviocampos]." from ".$_GET[mitabla]." where activo=1 order by id";
	}
}
