	...
	<script>
		...
		function doOnLoad() {
			...
			myLayout = new dhtmlXLayoutObject({
				...
				//parent: "layoutObj",
				pattern: "3J",
				cells: [{id: "a", text: "Cargar Documento(s) Escaneados >>> ", width: 460, height: 180   },{id: "b", text: "Visualizar Informacion"   },{id: "c", text: "Visualizar Anexo"   } ]
...
formData = [
  {type: "settings", position: "label-left", labelWidth: 100, inputWidth: 120},
	{type: "fieldset", label: "Anexos: ",  offsetLeft: 5, offsetRight: 5, offsetTop: 0, inputWidth: 300, list:[		
		...
		{type: "upload", name: "myFiles", inputWidth: 260,   offsetTop: 0, url: "php/carga_upload_imgs_ventan.php?vartxtciudcedula=<?php echo $_GET["vartxtciudcedula"];?>&vercodigotramitext=<?php echo $_GET["vercodigotramitext"];?>&ponnombresrespon=<?php echo $ponnombresrespon;?>", autoStart: true, swfPath: "uploader.swf", swfUrl: "php/carga_upload_imgs_ventan.php"},
]},
				...
				if (id == "send") 
					{
						  ...
						  //  type:"confirm",
						    ...
						    callback: function() {
								...
								window.open("service_imprimecods.php?micodappsc=<?php echo $_GET["varcodgenerado"]; ?>" , "ventana1" , "width=700,height=500,scrollbars=NO");
